...
class Whirlpool {
	...
	public void NESSIEfinalize(byte[] digest) {
		...
		bufferPos++; // all remaining bits on the current byte are set to
		// zero.
	...
	public static void makeISOTestVectors() {
		...
		System.out.println("The hash-code is the following 512-bit string.\n\n"
				+ display(digest) + "     "+display(digest).length()+"\n");
		...
		w.NESSIEinit();
		w
				.NESSIEadd("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
		w.NESSIEfinalize(digest);
		System.out.println("The hash-code is the following 512-bit string.\n\n"
				+ display(digest) + "\n");
		...
		w.NESSIEinit();
		w
				.NESSIEadd("12345678901234567890123456789012345678901234567890123456789012345678901234567890");
		w.NESSIEfinalize(digest);
		System.out.println("The hash-code is the following 512-bit string.\n\n"
				+ display(digest) + "\n");
